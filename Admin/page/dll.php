...
<script type="text/html" id="userEditDialog">
    <form id="userEditForm" lay-filter="userEditForm" class="layui-form model-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label layui-form-required">插件名称:</label>
            <div class="layui-input-block">
                <input name="name" placeholder="请输入插件名称" class="layui-input"
                       />
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="download" value="" placeholder="请输入排序" class="layui-input"
                       lay-verType="tips" lay-verify="required" required/>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label layui-form-required">插件介绍:</label>
            <div class="layui-input-block">
                <textarea class="layui-textarea" name="title" rows="10" placeholder="输入插件介绍" required></textarea>
            </div>
        </div>
    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'xmSelect'], function () {
        ...
        var insTb = table.render({
            ...
            cols: [[
                ...
                {field: 'title', title: '介绍', width: 550},
            ...
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    form.on('submit(userEditSubmit)', function (data) {
                        ...
                        $.post(mData ? '../Ajax.php?act=Edit_dll' : '../Ajax.php?act=Add_dll', data.field, function (res) {  // 实际项目这里url可以是mData?'user/update':'user/add'
