...
<head>
    ...
    <title>管理登录-<?=$conf['sitename']?></title>
...
<div class="login-wrapper layui-anim layui-anim-scale layui-hide">
    <form class="layui-form">
        ...
        <div class="layui-form-item layui-input-icon-group">
            ...
            <input class="layui-input" name="admin_user" placeholder="请输入登录账号" autocomplete="off"
                   lay-verType="tips" lay-verify="required" required/>
        </div>
        <div class="layui-form-item layui-input-icon-group">
            <i class="layui-icon layui-icon-password"></i>
            <input class="layui-input" name="admin_pass" placeholder="请输入登录密码" type="password"
                   lay-verType="tips" lay-verify="required" required/>
        </div>
        <?php if($conf['goid']){?>
        <div class="layui-form-item layui-input-icon-group">
            <i class="layui-icon layui-icon-auz"></i>
            <input class="layui-input" name="code" placeholder="请输入谷歌验证码"
                   lay-verType="tips" lay-verify="required" required/>
        </div>
        <?php }?><!--
...
<div class="login-copyright">copyright © 2021-2024 www.100b.cn all rights reserved.</div>
...
<script>
    layui.use(['layer', 'form'], function () {
        ...
        form.on('submit(loginSubmit)', function (data) {
            ...
            $.ajax({
    			type : "POST",
    			url : "Ajax.php?act=Login&t=" + (new Date()).getTime(),
    			data : {admin_user:data.admin_user,admin_pass:data.admin_pass,code:data.code},
    			dataType : 'json',
