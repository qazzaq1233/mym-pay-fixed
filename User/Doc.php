...
<meta name="viewport"content="width=device-width, initial-scale=1"/>
  	<link rel="shortcut icon" href="../Mym/Assets/Img/favicon.ico">
...
<link rel="stylesheet"href="/Mym/Assets/Doc/bootstrap.css"type="text/css"/>
<link rel="stylesheet"href="/Mym/Assets/Doc/common.css">
<link rel="stylesheet"href="/Mym/Assets/Doc/index-top.css">
<!--[if IE 9 ]><style type="text/css">#ie9{ display:block; }</style><![endif]-->
<script src="/Mym/Assets/Doc/jquery.min.js"></script>
<script src="/Mym/Assets/Doc/bootstrap.js"></script>
<script src="/Mym/Assets/Doc/jquery-ujs.js"async="true"></script>
<link rel="stylesheet"type="text/css"href="/Mym/Assets/Doc/index.css"/>
<style type="text/css">body{color:#000;}header { position: relative; }</style>
</head>
<body>
<![endif]--><link rel="stylesheet"href="/Mym/Assets/Doc/common1.css"/>
...
<a href="/"><span class="logo" style="background:url(/Mym/Assets/Img/logo.png) no-repeat;height: 45px"></span></a>
</div>
...
<p>URL地址：<?php echo $siteurl?>submit.php?pid={商户ID}&amp;type={支付方式}&amp;out_trade_no={商户订单号}&amp;notify_url={服务器异步通知地址}&amp;return_url={页面跳转通知地址}&amp;name={商品名称}&amp;money={金额}&amp;sitename={网站名称}&amp;sign={签名字符串}&amp;sign_type=MD5</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<ul class="price">
<h4>关于我们</h4>
<li><?=$conf['sitename']?>是MYM网络科技有限公司旗下的免签约支付产品</li>
</ul>
<ul class="about"style="width: 40%;padding-left: 22px;">
<h4>联系我们</h4>
<li><strong>QQ:</strong><a target="_blank"href="//wpa.qq.com/msgrd?v=3&amp;uin=<?=$conf['qq']?>&amp;site=qq&amp;menu=yes"><?=$userrow['qq']?></a></li>
<li><strong>Email:</strong><a name="baidusnap4"></a><a href="mailto:<?=$conf['qq']?>@qq.com"><?=$conf['qq']?>@qq.com</a></li>
</ul>
</div>

</div>
<div class="xinxi">
<p>Copyright (c) 2022 <?=$conf['sitename']?>  | Powered by </p>