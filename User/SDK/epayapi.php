...
/**************************请求参数**************************/
        ...
        //商户订单号
        $out_trade_no = daddslashes($_POST['WIDout_trade_no']?$_POST['WIDout_trade_no']:$_GET['WIDout_trade_no']);
		//付款金额
        $money = daddslashes($_POST['WIDtotal_fee']?$_POST['WIDtotal_fee']:$_GET['WIDtotal_fee']);
        //必填
