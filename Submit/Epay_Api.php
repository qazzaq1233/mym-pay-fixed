...
/**************************请求参数**************************/
$notify_url = ($_SERVER['SERVER_PORT'] == '443' ? 'https://' : 'http://').$_SERVER['HTTP_HOST']."/Submit/Epay_notify_url.php";
//需http://格式的完整路径，不能加?id=123这类自定义参数

//页面跳转同步通知页面路径
$return_url = ($_SERVER['SERVER_PORT'] == '443' ? 'https://' : 'http://').$_SERVER['HTTP_HOST']."/Submit/Epay_return_url.php";
...
$parameter = array(
		...
		"out_trade_no"	=> daddslashes($trade_no),
